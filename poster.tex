...
\begin{itemize}
    ...
    \begin{enumerate}
        \item UI bien avancé (page d'acceuil
        \item 
    \end{enumerate}
\end{itemize}
...
\begin{center}
\begin{itemize}
    \item Simulateur: L'implémentation du moteur avance, mais est encore en retard et le reste du projet avance bien 
    \item BMS: 
    \item Contrôle Moteur: Moteur fait n'importe quoi Lmao
    \item Instrumentation: En retard du côté électrique donc ça cause des incertitude au niveau informatique
    \item Télémétrie: Implémentation d'un nouveau framework mobile (Native React) car le précédent manquait de support.
\end{itemize}
\end{center}
\vspace{1cm}
...
\begin{center}
    \includegraphics[clip, trim=0cm 12cm 3cm 1.6cm, scale=1]{img/argent.pdf}
\end{center}
}
%\hspace{1cm}
