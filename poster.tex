...
\begin{itemize}
    ...
    \item Instrumentation: L'objectif d'avoir un prototype d'ici la fin de la session n'est plus réaliste. Il n'y aura pas de carte électronique à tester. L'instrumentation se contentera d'avoir un système prêt à être implémenté.
    \item Télémétrie: Passage au "bare workflow" de React Native plutôt que exclusivement la méthodologie Expo. La raison est que le bluetooth n'est pas encore supporté dans Expo.
\end{itemize}
\end{center}
