...
\begin{center}
\begin{itemize}
    \item Simulateur: Retard moins grand, et plusieurs préparation en cours pour présenter le simulateur% Claude 2022-10-12
    \item Contrôle Moteur: Tuning PI de commande de torque avec STM32CubeMonitor. Changement microcontrôleur L4 pour H7
    \item Instrumentation: Début de l'intégration au véhicule et établir la communication avec le BMS. % CEG 2022-10-12
\end{itemize}
\end{center}
