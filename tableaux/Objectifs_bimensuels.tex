...
\begin{tabularx}{\linewidth}{
    ...
    \textbf{Planifié} & \textbf{Progrès} & \textbf{Objectif} & \textbf{Responsable} \\\hline
      25\% & 5\% & Implémenter la lecture de courant à partir des capteurs de l'onduleur & Gabriel Q.\\\hline
      25\% & 25\% & Tests avec la première version de l'onduleur de l'équipe & Gabriel Q.\\\hline
      50\% & 10\% & Programmer le STM32 à partir du débugger externe  & Louis Tardif.\\\hline 
      50\% & 20\% & Foaire l'étude de consommation énergetique du STM32 avec le "shield" ST  & Louis Tardif.\\\hline
\end{tabularx}
\newline
...
\begin{tabularx}{\linewidth}{
    ...
    \hline
    \textbf{Planifié} & \textbf{Progrès} & \textbf{Objectif} & \textbf{Responsable} \\\hline
        75\% & 75\% & {Création et modification de tests unitaires} & Marian L-R \\\hline
