...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Consommation énergétique STM32
        \item Retard dans le simulateur
    \end{enumerate}
\end{itemize}
...
\begin{center}
\begin{itemize}
    \item Simulateur: Retard sur l'objectif de session qui devrait être terminer (manque le moteur)
    \item Un léger retard pour controle, pile poil pour BMS et Instrumentation.
    \item La courbe en s doit être réajusté
\end{itemize}
\end{center}
\vspace{1cm}
...
%\hspace{1cm}
\begin{center}
    \includegraphics[clip, scale=1]{img/test.pdf}
\end{center}
}
