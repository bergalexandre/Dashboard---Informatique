...
\vspace{0.50cm} % spacing vertical
...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Tour des 3 systèmes.
        \item Discussion Contrôle Moteur.
    \end{enumerate}
\end{itemize}

\vspace{0.35cm} % spacing vertical
}
...
\hspace{1cm}
\begin{center}
    \includegraphics[scale=0.75]{img/silent_motor.png}
\end{center}
}
...
\begin{center}
\begin{itemize}
    \item Simulateur: Un peu de retard sur la stratégie de conduite, mais il y a des avancements et on a des nouvelles stratégies pour tester  % Claude 2022-09-21
    \item Contrôle Moteur: En attente d'un montage avec un encodeur bien aligné à un moteur; Lectures courant de phase synchronisées avec les PWM complétées. Fonction pour contrôler en torque à faire pour les tests dynamomètre.
    \item Instrumentation: Vérification de la librairie e-paper commencée, il manque des fonctions pour l'utiliser dans la boucle principale du MCU. % CEG 2022-09-14
    \item 
\end{itemize}
\end{center}
