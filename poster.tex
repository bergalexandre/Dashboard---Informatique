...
\begin{center}
\begin{itemize}
    \item Simulateur: Simulateur a de drôle de reaction au pilote. Il va falloir investir du temps pour règler cela.% Claude 2022-09-28
    \item Contrôle Moteur: Tuning PI de commande de torque avec STM32CubeMonitor. Boucle ouverte fonctionnelle; boucle fermée à compléter. Correction nombre paire de pôles. Test avec moteur de l'équipe RISE.
    \item Instrumentation: Un peu de retard sur lib CAN  et contrôle de l'intensité. % CEG 2022-09-14
    \item 
\end{itemize}
\end{center}
