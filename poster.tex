...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Tâches cruciales terminées pour le UI (page d'accueil/comparaison)
        \item Changement de design pour les lumières du véhicule
    \end{enumerate}
\end{itemize}
...
\begin{center}
\begin{itemize}
    \item Simulateur: L'implémentation du moteur avance, mais est encore en retard et le reste du simulateur avance bien 
