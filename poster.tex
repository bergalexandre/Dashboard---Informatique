...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Recommendation pour la lecture de la pédale de torque.
...
\hspace{1cm}
\begin{center}
    \includegraphics[scale=0.24]{img/meme.png}
\end{center}
}
...
\begin{itemize}
    ...
    \item Contrôle Moteur: Correction des opérations mathématiques dans la boucle FOC. Intégration de STM32CubeMonitor pour enregistrer et "tuner" des variables. Boucle ouverte fonctionnelle; boucle fermée à compléter
