...
\begin{tabularx}{\linewidth}{
    ...
    \textbf{Planifié} & \textbf{Progrès} & \textbf{Objectif} & \textbf{Responsable} \\\hline
        ...
        100\% & 95\% & Afficher le bilan énergitique par système dans l'interface & Malik C.\\\hline %a verifier
        100\% & 50\% & Comparaison entre deux simulation & Malik C.\\\hline  %a verifier
        ...
        100\% & 50\% & Implémentation du générateur de parcours dans l'interface
