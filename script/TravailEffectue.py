...
class TravailEffectue():
    ...
    def fetchData(self):
        ...
        data = df_travail_effectue[['NOM', 'Nom Système', 'Objectif', 'heures']].dropna()[df_travail_effectue['Semaine'] == semaine_courante]
    ...
    def graphSave(self):
        ...
        column_headers = ['Membre', 'Nom Système', 'Objectif', 'Heures']
