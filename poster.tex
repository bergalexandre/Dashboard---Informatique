...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Problèmes des lumières instrumentation.
    \end{enumerate}
\end{itemize}
...
\hspace{1cm}
\begin{center}
    \includegraphics[scale=0.5]{img/meme.png}
\end{center}
}
...
\begin{center}
\begin{itemize}
    \item Simulateur: Retard au niveau de certaines tâches qui va mener a une semaine de relâche bien occupé% Claude 2022-10-12
    \item Contrôle Moteur: Tuning PI de commande de torque avec STM32CubeMonitor.Test destructif avec moteur de l'équipe RISE.
    \item Instrumentation: Du retard sur lib CAN  et contrôle de l'intensité on doit recoder tout. % CEG 2022-10-04
\end{itemize}
\end{center}
