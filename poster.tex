...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Conclusion de la revue technique avec BRP
        \item Modification stratégie d'implémentation du moteur
    \end{enumerate}
\end{itemize}
...
\begin{center}
\begin{itemize}
    \item Simulateur: Retard sur l'implémentation du moteur
    \item Pile poil pour contrôle et instrumentation.
    \item Retard pour BMS
    \item La courbe en s doit être réajustée
\end{itemize}
\end{center}
\vspace{1cm}
...
\begin{center}
    \includegraphics[clip, trim=1.6cm 12cm 3cm 1.6cm, scale=1]{img/argent.pdf}
\end{center}
}
%\hspace{1cm}
