...
\hspace{1cm}
\begin{center}
    \includegraphics[scale=0.9]{img/silent_motor.png}
\end{center}
}
...
\begin{center}
\begin{itemize}
    \item Simulateur: On a ciblé les tâches importantes et on règle quelques bugs de la session dernière % Claude 2022-09-07
    \item Contrôle Moteur: Léger retard, logiciel fonctionnel n'est pas complété
    \item BMS : Louis doit faire le on-boarding de William ???
