...
\begin{center}
\begin{itemize}
    \item Simulateur: Ajustement important viendront pour les modèles mathématiques% Claude 2022-11-09
    \item Contrôle Moteur: Implémentation PID vitesse. Limitation des sorties. 
    \item Instrumentation: Continuation communication avec le BMS et début MQTT de télémétrie et interface simulateur. % CEG 2022-10-12
\end{itemize}
\end{center}
