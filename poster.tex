...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Installation atelier électronique
        \item Avancement programmation embarqué
        \item Avancement refactoring simulateur
    \end{enumerate}
\end{itemize}
...
\begin{center}
\begin{itemize}
    \item Simulateur: moins de fonctionnalités cette semaine, mais beaucoup de nettoyage
    \item Pile poil pour controle, BMS et Instrumentation.
\end{itemize}
\end{center}
\vspace{1cm}
...
\hspace{1cm}
\begin{center}
    \includegraphics[scale=.25]{img/cashflow.png}
\end{center}
}
