\begin{tabularx}{\linewidth}{
    ...
    \textbf{Problème} & \textbf{Système} & \textbf{Responsable} \\\hline
     Gestion les steps python vs ltspice & Simulateur & M.L.R., C.G.P., M.P. \\\hline %28/07/2021
     Approximation du OCV pour la mesure de la tension à la sortie de la batterie & Simulateur & M.P., C.G.P \\\hline
     Structure avec les bonness données à afficher & Simulateur & W.R. \\\hline
     La flash du argon a explosé & Instrumentation & A.B.\\\hline
     Le rapport automatisé ne se génère pas bien après mercredi minuit & Gestion & A.B.\\\hline
  \end{tabularx}
